    ...
    <PrototypeShell current="/assinar">
      <div className="access-layout">
        <section className="access-intro">
          <p className="eyebrow">Seu plano, seu espaço</p>
          <h1>{pro ? "Mais espaço" : "O primeiro passo"}<br /><span>para criar.</span></h1>
        ...
        <section className="panel access-card" aria-labelledby="plan-title">
          ...
          <p>{pro ? "Exportações ilimitadas." : "2 exportações por mês por conta."}<br />Todos os recursos visuais incluídos.</p>
