...
export default function EditorPage() {
  ...
  const resetEditor = () => {
    ...
    setAppIcon("/images/nu-notification-icon-v1.png"); setCustomIconUrl(""); setExportMessage("A imagem será baixada em PNG com 1080 × 1920 px.");
  };
  ...
  const downloadPng = async () => {
    ...
    try {
      ...
      const link = document.createElement("a"); link.download = `notivy-${Date.now()}.png`; link.href = canvas.toDataURL("image/png"); link.click();
