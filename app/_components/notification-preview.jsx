  ...
  return (
    <figure className="preview-figure">
      <div className="phone-shell-3d phone-shell-iphone16">
        ...
        <div
          ref={(element) => { canvasRef.current = element; if (previewRef) previewRef.current = element; }}
        ...
        >
          <span className="dynamic-island" data-preview-layer="8" aria-hidden="true"><i /></span>
          {editableLockScreen && (
            <div data-preview-layer="3" className="editable-lock-ui" aria-hidden="true">
              ...
              <time className="editable-main-time" style={{ fontFamily: `"${clockFont}", ui-rounded, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif`, fontWeight: clockWeight, color: clockColor, fontSize: `${clockSize}px`, letterSpacing: `${clockSpacing}em` }}>{mainTime}</time>
            </div>
          )}
          ...
          >
            ...
            <span className="notification-readable-copy">
              <strong className="notification-app-name">{appName}</strong>
          ...
          {renderControls && (
            <>
              ...
              <span data-preview-layer="5" className="home-indicator" aria-hidden="true" />
            </>
          )}
        </div>
      </div>
